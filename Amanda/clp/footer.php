  ...
  <section class="footer-section">
    <div class="footer-wrapper">
      <div class="social-box">
        <svg id="Layer_1" class="social-icon" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
          <defs>
            <style>.cls-1{fill:none;}.cls-2{fill:#fff;}</style>
          </defs>
          <title>facebook</title>
          <circle class="cls-1" cx="24" cy="24" r="24"/>
          <path class="cls-2" d="M20,39h6V24h4.45L31,18H26.23V15.6a1.27,1.27,0,0,1,1.33-1.44h3.37V9L26.29,9C21.15,9,20,12.83,20,15.29V18H17v6h3Z"/>
          <circle class="cls-1" cx="24" cy="24" r="24"/>
          <path class="cls-2" d="M20,39h6V24h4.45L31,18H26.23V15.6a1.27,1.27,0,0,1,1.33-1.44h3.37V9L26.29,9C21.15,9,20,12.83,20,15.29V18H17v6h3Z"/><circle class="cls-1" cx="24" cy="24" r="24"/>
          <path class="cls-2" d="M20,39h6V24h4.45L31,18H26.23V15.6a1.27,1.27,0,0,1,1.33-1.44h3.37V9L26.29,9C21.15,9,20,12.83,20,15.29V18H17v6h3Z"/>
        </svg>
      </div>
      <div class="sitemap">
